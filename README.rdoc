...
rails c
Running via Spring preloader in process 22705
Loading development environment (Rails 4.2.5.2)
2.3.0 :001 > Task.find(:all, conditions: ['complete = ?, false])
2.3.0 :002'> ^C
2.3.0 :002 > Task.find(:all, conditions: ['complete = ?', false])
...
2.3.0 :005 > incomplete_tasks.class
 => Task::ActiveRecord_Relation 
2.3.0 :006 > incomplete_tasks.to_a
